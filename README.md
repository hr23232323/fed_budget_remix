...
- **Label Wrapping**: While this may sound like a farily straightforward change, enabling container width-based text wrapping in treemaps was very difficult. I created a custom method to achieve this which can be seen in my scripts.js file. This addition helped me wrap my labels in the treemap, making it cleaners and even helped me hide long labels.
